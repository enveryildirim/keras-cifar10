...
def tahmin_matrisi(y_test,y_pred):
    target_names = ['sınıf 0(ucak)', 'sınıf 1(otomobil)', 'sınıf 2(kus)','sınıf 3(kedi)','sınıf 4(geyik)', 
	'sınıf 5(kopek)', 'sınıf 6(kurbağa)','sınıf 7(geyik)','sınıf 8(gemi)','sınıf 9(kamyon)']
